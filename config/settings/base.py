...
ROOT_DIR = environ.Path(__file__) - 3  # (geolo/config/settings/base.py - 3 = geolo/)
APPS_DIR = ROOT_DIR.path('geolo')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///geolo'),
}
...
LOCAL_APPS = [
    'geolo.users.apps.UsersAppConfig',
    # My Apps
    'app',
    'geolo',
]
...
MIGRATION_MODULES = {
    'sites': 'geolo.contrib.sites.migrations'
}
...
STATICFILES_DIRS = [
    ...
    str(APPS_DIR.path('geolo/static')),
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            str(APPS_DIR.path('geolo/templates')),
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'geolo.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'geolo.users.adapters.SocialAccountAdapter'
